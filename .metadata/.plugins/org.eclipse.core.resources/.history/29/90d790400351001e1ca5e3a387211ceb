...
public class BoardDto {
	...
	private String brd_category, title, brd_content, mem_id;
	private Date brd_date_created;
	
public BoardDto() {
	// TODO Auto-generated constructor stub
}

public BoardDto(int brd_id, int brd_view, int brd_declaration, int brd_suggestion, String brd_category, String title,
		String brd_content, String mem_id, Date brd_date_created) {
	super();
	this.brd_id = brd_id;
...
public Date getBrd_date_created() {
	return brd_date_created;
}

public void setBrd_date_created(Date brd_date_created) {
	this.brd_date_created = brd_date_created;
}
