				...
				<div class="sidemenubox">
					...
					<ul class="list-unstyled ">
						<li><a
							...
							href="/jgig/member_detail"> <!--선택된 메뉴는 selectsidemenu 클래스 추가 -->
								내 정보
						</a></li>
						<li><a
					...
					<div id="service-content">
						...
						<body>
							...
							<div class="find_btn d-flex">
								<form action="member_update" class="mr-2">
									<button type="submit" class="btn btn-navy navbar-btn find-btn1">정보수정</button>
								</form>
								<form action="member_delete">
									<button type="submit" class="btn btn-navy navbar-btn find-btn1">회원탈퇴</button>
								</form>
							</div>
