				...
				<div class="row">
					<div id="service-content">
						...
						<form id="memberCheckForm" action="member_check" method="post">
							<span class="font-weight-bold">상품명</span> <select name="act_name">
								<option>선택</option>
							...
							<label for="mem_nm" class="font-weight-bold">이름</label> <input
								type="text" name="mem_nm" id=" " required><br> <label
								for="ssn1" class="font-weight-bold">주민등록번호</label> <input
								type="text" name="ssn1" minlength=6 maxlength=6 required>
							- <input type="text" name="ssn2" minlength=7 maxlength=7 required><br>

							<label for="phone_num1" class="font-weight-bold">휴대폰번호</label> <input
								type="text" name="phone_num1" minlength=2 maxlength=3 required>
							- <input type="text" name="phone_num2" minlength=3 maxlength=4
								required> - <input type="text" name="phone_num3"
								minlength=3 maxlength=4 required><br>
							<div>
						...
						<form action="open_account2" method="post">
							...
							<fieldset id="check_user">
								...
								<p>본인은 귀사가 「개인정보보호법」 및 「신용정보의 이용 및 보호에 관한 법률」 에 따라 본인의
									개인(신용)정보를 다음과 같이 수집·이용하는 것에 동의합니다 개인(신용)정보 수집·이용 목적 : 비대면 계좌개설
									신청여부 확인 수집·이용할 개인(신용)정보의 내용 : 주민등록번호 개인(신용)정보의 보유·이용기간 : 신청일로부터
									30일 이내 ※ 상기 동의를 거부하실 경우 비대면 계좌개설이 불가합니다.</p>
							</fieldset>
							<div class="float-right">
								<input type="radio" class="option1" id="option1" name="check"
									value="yes"> <label for="option1">동의</label> <input
									type="radio" class="option2" id="option2" name="check"
									value="no"> <label for="option2">비동의</label> <br>
