...
public interface MainMapper {
	...
	@Select("select * from board where BRD_CATEGORY='자유' order by BRD_DATE_CREATED desc")
	public List<BoardDto> free_list();
	
	@Select("select * from board where BRD_CATEGORY='질문' order by BRD_DATE_CREATED desc")
