                    ...
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <hr>
                                <li><a class="dropdown-item" href="/jgig/card_issuance">카드발급</a></li>
                        ...
                        <c:if test="${not empty sessionScope.mem_id}">
                            <li class="nav-item dropdown">
                                <a class="nav-icon position-relative text-decoration-none nav-link"
                                   href="/jgig/member_detail" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
            ...
            <div class="col-lg-2">
                <div class="sidemenubox">
                    ...
                    <ul class="list-unstyled ">
                        <li><a class="collapsed d-flex justify-content-between text-decoration-none" href="#">
                                <!--선택된 메뉴는 selectsidemenu 클래스 추가 --> 계좌 개설
                            </a></li>
                        <li><a class="collapsed d-flex justify-content-between  text-decoration-none" href="#">
                                계좌 조회 및 이체
                            </a></li>
                        ...
                        <hr>
                        <li><a class="collapsed d-flex justify-content-between text-decoration-none selectsidemenu "
                               href="/jgig/card_issuance"> 카드발급 </a></li>
                        <li><a class="collapsed d-flex justify-content-between text-decoration-none "
                                    ...
                                    <table id="issu_info_table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="cd_ssn_1" class="border-bt"
                                                           placeholder="앞 6자리" maxlength="6"> - <input type="text"
                                                                                                      name="cd_ssn_2"
                                                                                                      class="border-bt"
                                                                                                      placeholder="뒤 7자리"
                                                                                                      maxlength="7">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="tel1" class="border-bt" maxlength="3"> -
                                                    <input type="text" name="tel2" class="border-bt" maxlength="4"> -
                                                    <input type="text" name="tel3" class="border-bt" maxlength="4">
                            ...
                            <div class="subcontent">
                                ...
                                <div class="subcontent">
                                    <div class="terms-container">
                                        <p>귀하는 개인신용정보 수집·이용·조회 및 제공 동의에 대해 거부하실 수 있습니다.
                                            다만, 개인(신용)정보 수집·이용·조회 및 제공에 관한 동의는 KB국민카드(KB국민비씨카드의
                                            경우 비씨카드㈜ 포함. 이하 같습니다.)와의 상거래 관계의 설정, 유지에 필수적이거나 상거래
                                            관계에 따라 귀하에게 제공되는 서비스와 직접적으로 관련된 필수적 사항이므로 아래의
                                            사항에 동의하셔야만 거래관계의 설정 및 유지가 가능합니다.
                                            귀하는 개인신용정보 수집·이용·조회 및 제공 동의에 대해 거부하실 수 있습니다.
                                            다만, 개인(신용)정보 수집·이용·조회 및 제공에 관한 동의는 KB국민카드(KB국민비씨카드의
                                            경우 비씨카드㈜ 포함. 이하 같습니다.)와의 상거래 관계의 설정, 유지에 필수적이거나 상거래
                                            관계에 따라 귀하에게 제공되는 서비스와 직접적으로 관련된 필수적 사항이므로 아래의
                                            사항에 동의하셔야만 거래관계의 설정 및 유지가 가능합니다.
