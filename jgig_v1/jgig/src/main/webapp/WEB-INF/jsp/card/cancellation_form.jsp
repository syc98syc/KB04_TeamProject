...
<c:if test="${not empty sessionScope.errorMessage_cancel}">
    <script>
        alert("${sessionScope.errorMessage_cancel}"); // errorMessage를 alert 창에 표시
    </script>
</c:if>
...
<table>
	...
	<form action=card_cancellation_action method="post">
	<h3>본인인증</h3>
